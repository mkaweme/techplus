  ...
  return (
    <div className="flex flex-col items-center">
      ...
      <section className="flex flex-col w-full" id="construction">
        <div className="flex w-full justify-center align-middle items-center bg-[url('/work_together_background.png')] bg-cover bg-fixed h-[300px]">
          <h3 className="text-[36px] font-bold text-white text-center">CIVIL CONSTRUCTION WORKS AND MAINTENANCE SERVICES</h3>
        </div>
        <div className="flex flex-col lg:flex-row mx-20 my-16">
          <div className="w-[60%]">
            <p className="text-[20px] mx-6">Techplus offers construction services from design to commissioning. We have an 
              expert team of civil engineers, technicians and bricklayers who can construct the following;
            </p>
            <ul className="flex flex-col mx-12 gap-y-3 mt-4 text-[18px]">
              ...
              <li className="flex flex-row"><Icon icon="octicon:dash-16" width="24" height="24" color="#F89E3E"/> Renovation of Building/monuments/landmarks and Painting</li>
            </ul>
          </div>
          <div>
            <Image src="/construction.png" alt="Construction" width={500} height={500} className="border-[14px] border-[#F89E3E]"/>
          </div>
        </div>
      </section>
      <section className="flex flex-col w-full" id="electrical">
        <div className="flex w-full justify-center align-middle items-center bg-[url('/work_together_background.png')] bg-cover bg-fixed h-[300px]">
          <h3 className="text-[36px] font-bold text-white text-center">ELECTRICAL INSTALLATION AND MAINTENANCE SERVICES</h3>
        </div>
        <div className="flex flex-col lg:flex-row mx-20 my-16">
          <div className="w-[60%]">
            <p className="text-[20px] mx-6">Techplus can undertake a very wide scale of electrical projects ranging from 
          ...
          <div>
            <Image src="/electrical.png" alt="electrical_intallation" width={500} height={500} className="border-[14px] border-[#F89E3E]"/>
          </div>
        </div>
      </section>
      <section className="flex flex-col w-full" id="telecommunication">
        <div className="flex w-full justify-center align-middle items-center bg-[url('/work_together_background.png')] bg-cover bg-fixed h-[300px]">
          <h3 className="text-[36px] font-bold text-white text-center">
            TELECOMMUNICATION INSTALLATION & MAINTENANCE SERVICES
          </h3>
        </div>
        <div className="flex flex-col lg:flex-row mx-20 my-16">
          <div className="w-[60%]">
            <p className="text-[20px] mx-6">
          ...
          <div>
            <Image src="/telecommunication.png" alt="electrical_intallation" width={500} height={500} className="border-[14px] border-[#F89E3E]"/>
          </div>
        </div>
      </section>
    </div>
