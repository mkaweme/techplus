...
const About = () => {
  return (
      <div className="flex flex-col items-center bg-black min-h-screen lg:h-[110vh] pb-10">
        ...
        <div className="flex flex-row relative">
          ...
          <div className="flex flex-col justify-center md:justify-start absolute bg-white lg:w-[40%] p-4 mx-6 lg:mx-0 h-90 md:h-[550px] lg:h-96 top-48 md:top-44 lg:top-40 lg:-right-48 z-10">
